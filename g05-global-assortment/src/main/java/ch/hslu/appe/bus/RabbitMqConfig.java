...
public final class RabbitMqConfig {
    ...
    private static final String ROUTE_GLOBALASSORTMENT_ORDER = "route.globalassortment.order";
    private static final String ROUTE_GLOBALASSORTMENT_LIST_ARTICLES = "route.globalassortment.article.list";
    ...
    public String getQueue() {
        return this.properties.getProperty(QUEUE);
    }

    public String getRouteGlobalAssortmentOrder() {
        return this.properties.getProperty(ROUTE_GLOBALASSORTMENT_ORDER);
    }

    public String getRouteGlobalAssortmentListArticles() {
        return this.properties.getProperty(ROUTE_GLOBALASSORTMENT_LIST_ARTICLES);
    }
}
